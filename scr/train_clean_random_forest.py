...
MODEL_FILE = Path(
    f"data/processed/{STOCK}_clean_random_forest_model.pkl"
)

METRICS_FILE = Path(
    f"data/processed/{STOCK}_clean_random_forest_metrics.csv"
)
...
print("\nTraining clean Random Forest model...")
...
importance_file = Path(
    f"data/processed/{STOCK}_clean_random_forest_feature_importance.csv"
)
